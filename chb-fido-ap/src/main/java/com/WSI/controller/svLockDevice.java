...
/**
 * Servlet implementation class svLockDevice
 */
@RestController
// @WebServlet(description = "鎖定裝置", urlPatterns = { "/svLockDevice" })
public class svLockDevice extends BaseServlet {
	@Autowired
	WSMServlet wsmServlet;

	@PostMapping("/svLockDevice")
	protected String doPost(@RequestBody Object reqBody, HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		inLogObj.setClazz("com.WSI.controller.svLockDevice");
		apLogObj.setTraceID(sessionID);
		apLogObj.setClazz("com.WSI.controller.svLockDevice");
...
//				+ ", Err_msg_path: " + Err_msg_path);
		...
		Log4jWSI.log.debug(
				"[" + sessionID + "][Version: " + svVerNo + "][svLockDevice] API key in header: " + headerApiKey);
		apLogObj.setMessage(
				"[" + sessionID + "][Version: " + svVerNo + "][svLockDevice] API key in header: " + headerApiKey);
		...
		if (headerApiKey == null || !WSI_API_Key.equals(headerApiKey)) {
			Log4jWSI.log.debug("[" + sessionID + "][Version: " + svVerNo
					+ "][svLockDevice] Reject client request for invalid API key");
...
//			new OutputHandler(res, "application/json; charset=UTF-8").OutResult(gts.common(ReturnCode.APIKeyInvalid));
		...
		try {
			...
			Log4jWSI.log.fatal("[" + sessionID + "][Version: " + svVerNo
					+ "][svLockDevice] Error occurred while reading body: " + e.getMessage());
...
//			new OutputHandler(res, "application/json; charset=UTF-8").OutResult(gts.common(ReturnCode.InternalError));
		...
		Log4jWSI.log.info("[" + sessionID + "][Version: " + svVerNo + "][svLockDevice] Msg from body: " + jsonString);

		apLogObj.setMessage("[" + sessionID + "][Version: " + svVerNo + "][svLockDevice] Msg from body: " + jsonString);
		...
		try {
			...
			Log4jWSI.log.error(
					"[" + sessionID + "][Version: " + svVerNo + "][svLockDevice] Unable to parse client JSON msg: "
...
//			new OutputHandler(res, "application/json; charset=UTF-8").OutResult(gts.common(ReturnCode.JsonParseError));
		...
		// log locale
		Log4jWSI.log.trace("[" + sessionID + "][Version: " + svVerNo + "][svLockDevice] Locale: " + req.getLocale());

		apLogObj.setMessage("[" + sessionID + "][Version: " + svVerNo + "][svLockDevice] Locale: " + req.getLocale());
		...
		if (!map.containsKey("Error")) {
			...
			Log4jWSI.log.info("[" + sessionID + "][Version: " + svVerNo + "][svLockDevice] channel: " + channel
					+ ", idgateID: " + idgateID);

			apLogObj.setMessage("[" + sessionID + "][Version: " + svVerNo + "][svLockDevice] channel: " + channel);
			Log4jAP.log.info(apLogObj.getCompleteTxt());
		} else {
			Log4jWSI.log.info("[" + sessionID + "][Version: " + svVerNo + "][svLockDevice] Error: " + map.get("Error")
...
//						.OutResult(gts.common(ReturnCode.ChannelInvalidError));
			...
			if (memVO == null) {
				Log4jWSI.log.info("[" + sessionID + "][Version: " + svVerNo
						+ "][svLockDevice] Member not found. Response: " + gts.common(ReturnCode.MemberNotFound));
...
//						.OutResult(gts.common(ReturnCode.MemberNotFound));
				...
				Log4jWSI.log.info("[" + sessionID + "][Version: " + svVerNo
						+ "][svLockDevice] Member channel not match. Response: "
...
//						.OutResult(gts.common(ReturnCode.ChannelNotMatchToMember));
			...
			if (memVO.getCustomer_Status().equals(MemberStatus.Deleted)) {
				Log4jWSI.log.info("[" + sessionID + "][Version: " + svVerNo + "][svLockDevice] Response: "
						+ gts.get_DeviceStatus(ReturnCode.MemberDeletedError, memVO.getCustomer_Status(), null, null,
								null, null, null, null, null, null, null));

				apLogObj.setMessage("[" + sessionID + "][Version: " + svVerNo + "][svLockDevice] Response: "
						+ gts.get_DeviceStatus(ReturnCode.MemberDeletedError, memVO.getCustomer_Status(), null, null,
								null, null, null, null, null, null, null));
				Log4jAP.log.info(apLogObj.getCompleteTxt());

				inLogObj.setExecuteTime(System.currentTimeMillis() - startTime);
				inLogObj.setResponseTxt(gts.get_DeviceStatus(ReturnCode.MemberDeletedError, memVO.getCustomer_Status(),
						null, null, null, null, null, null, null, null, null));
				Log4jInbound.log.info(inLogObj.getCompleteTxt());

//				new OutputHandler(res, "application/json; charset=UTF-8")
//						.OutResult(gts.get_DeviceStatus(ReturnCode.MemberDeletedError, memVO.getCustomer_Status(), null,
//								null, null, null, null, null, null, null, null));
				return gts.get_DeviceStatus(ReturnCode.MemberDeletedError, memVO.getCustomer_Status(), null,
						null, null, null, null, null, null, null, null);
				...
				Log4jWSI.log.info("[" + sessionID + "][Version: " + svVerNo + "][svLockDevice] Response: "
						+ gts.get_DeviceStatus(ReturnCode.MemberLockedError, memVO.getCustomer_Status(), null, null,
								null, null, null, null, null, null, null));
				...
				inLogObj.setExecuteTime(System.currentTimeMillis() - startTime);
				inLogObj.setResponseTxt(gts.get_DeviceStatus(ReturnCode.MemberLockedError, memVO.getCustomer_Status(),
						null, null, null, null, null, null, null, null, null));
				Log4jInbound.log.info(inLogObj.getCompleteTxt());

//				new OutputHandler(res, "application/json; charset=UTF-8")
//						.OutResult(gts.get_DeviceStatus(ReturnCode.MemberLockedError, memVO.getCustomer_Status(), null,
//								null, null, null, null, null, null, null, null));
				return gts.get_DeviceStatus(ReturnCode.MemberLockedError, memVO.getCustomer_Status(), null,
						null, null, null, null, null, null, null, null);
			}
			...
			memSrv.addMemberStatusLog(memVO.getIDGateID(), memVO.getCustomer_Status(), MemberStatus.Locked,
					"Issued by " + channel);

		} catch (SQLException e) {
			Log4jWSI.log.error("[" + sessionID + "][Version: " + svVerNo + "][svLockDevice] DB Error occurred: "
					+ e.getMessage() + ", stacktrace: " + new Gson().toJson(e.getStackTrace()));

			apLogObj.setMessage(
					"[" + sessionID + "][Version: " + svVerNo + "][svLockDevice] DB Error occurred: " + e.getMessage());
			apLogObj.setThrowable(e.getMessage());
...
//			new OutputHandler(res, "application/json; charset=UTF-8").OutResult(gts.common(ReturnCode.DatabaseError));
		...
		Log4jWSI.log.trace("[" + sessionID + "][Version: " + svVerNo + "][svLockDevice] Sending to FIDO svLockDevice API");
		apLogObj.setMessage(
				"[" + sessionID + "][Version: " + svVerNo + "][svLockDevice] Sending to FIDO svLockDevice API");
		Log4jAP.log.info(apLogObj.getCompleteTxt());

		// outward data to FIDO server
		HashMap<String, String> formparams = new HashMap<String, String>();
		formparams.put("method", "svLockDevice");
...
//			retMsg = new Send2Remote().sendPost(FIDO_SV_IP, WSI_API_Key, gson.toJson(formparams));
			...
			Log4jWSI.log.error("[" + sessionID + "][Version: " + svVerNo + "][svLockDevice] Connection to FIDO error: "
					+ e.getMessage() + ", stacktrace: " + new Gson().toJson(e.getStackTrace()));

			apLogObj.setMessage("[" + sessionID + "][Version: " + svVerNo + "][svLockDevice] Connection to FIDO error: "
					+ e.getMessage() + ", stacktrace: " + new Gson().toJson(e.getStackTrace()));
			apLogObj.setThrowable(e.getMessage());
			Log4jAP.log.error(apLogObj.getCompleteTxt());
...
//			new OutputHandler(res, "application/json; charset=UTF-8").OutResult(gts.common(ReturnCode.FidoSVError));
		...
		Log4jWSI.log.info("[" + sessionID + "][Version: " + svVerNo + "][svLockDevice] FIDO SV Response: " + retMsg);

		apLogObj.setMessage("[" + sessionID + "][Version: " + svVerNo + "][svLockDevice] FIDO SV Response: " + retMsg);
		Log4jAP.log.info(apLogObj.getCompleteTxt());
		...
		if (map.containsKey("Error")) {
			Log4jWSI.log.debug("[" + sessionID + "][Version: " + svVerNo + "][svLockDevice] Error: " + map.get("Error"));
		...
		try {
			...
			Log4jWSI.log
					.error("[" + sessionID + "][Version: " + svVerNo + "][svLockDevice] Unable to parse FIDO JSON msg: "
							+ e.getMessage() + ", stacktrace: " + new Gson().toJson(e.getStackTrace()));

			apLogObj.setMessage("[" + sessionID + "][Version: " + svVerNo
					+ "][svLockDevice] Unable to parse FIDO JSON msg: " + e.getMessage());
			apLogObj.setThrowable(e.getMessage());
			Log4jAP.log.error(apLogObj.getCompleteTxt());
		...
		Log4jWSI.log.info("[" + sessionID + "][Version: " + svVerNo + "][svLockDevice] Response: " + retMsg);
