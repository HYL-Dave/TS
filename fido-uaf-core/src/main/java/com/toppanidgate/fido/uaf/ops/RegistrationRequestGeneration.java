...
import com.toppanidgate.fido.uaf.crypto.BCrypt;
...
import com.toppanidgate.fido.uaf.msg.OperationHeader;
import com.toppanidgate.fido.uaf.msg.Policy;
...
public class RegistrationRequestGeneration {
	...
	public static final String APP_ID = "https://uaf.toppanidgate.com/uaf/facets";
