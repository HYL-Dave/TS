...
import com.toppanidgate.fido.uaf.crypto.CertificateValidator;
import com.toppanidgate.fido.uaf.crypto.CertificateValidatorImpl;
import com.toppanidgate.fido.uaf.crypto.Notary;
import com.toppanidgate.fido.uaf.msg.AuthenticatorRegistrationAssertion;
...
import com.toppanidgate.fido.uaf.tlv.UnsignedUtil;
...
//	private Logger logger = Logger.getLogger(this.getClass().getName());
	...
	public RegistrationRecord[] processResponse(RegistrationResponse response, String testMode) throws Exception {
		...
		checkServerData(response.header.serverData, records, testMode);
...
//			logger.log(Level.INFO, "FC: " + fc);
			...
			Log4j.log.error("Fail to parse assertion: " + authenticatorRegistrationAssertion.assertion, e);
//			logger.log(Level.INFO, "Fail to parse assertion: " + authenticatorRegistrationAssertion.assertion, e);
	...
	private void checkAssertions(RegistrationResponse response) throws Exception {
	...
	private void checkServerData(String serverDataB64, RegistrationRecord[] records, String testMode) throws Exception {
		if (notary == null) {
			return;
		}
...
//			else {
////				System.out.println("*** Running:" + "true".equals(testMode));
//			}
